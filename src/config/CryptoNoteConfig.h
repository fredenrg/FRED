...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3              = 90000;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 100000; // Upgrade height for CN-Lite Variant 1 switch.
...
const int      SERVICE_DEFAULT_PORT                          =  8754;
